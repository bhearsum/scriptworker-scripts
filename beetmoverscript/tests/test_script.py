    ...
    (
        ...
        pytest.param(
            ...
            ],
            {
                ...
                "public/build/live.log": ["some/dir/live.log"],
            },
...
def test_upload_translations_artifacts(context, upstream_artifacts, artifact_map, expected_uploads, mocker):
    with tempfile.TemporaryDirectory() as tmp:
        ...
        upload_translations_artifacts(context)
