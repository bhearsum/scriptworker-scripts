...
# This code was originally written by mhowell in https://bugzilla.mozilla.org/show_bug.cgi?id=1261140
...
async def sign_authenticode_file(context, orig_path, fmt, *, authenticode_comment=None):
    ...
    if fmt.endswith(("authenticode_stub", "authenticode_sha2_stub", "authenticode_sha2")):
    ...
    write_attribution_data(infile, "source%3Dgoogle.com%26medium%3Dorganic%26campaign%3D(not%20set)%26content%3Dbhearsum234")
